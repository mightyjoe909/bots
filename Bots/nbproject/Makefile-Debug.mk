...
${OBJECTDIR}/_ext/5c0/bot.o: ../bot.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -D__BOTS=1 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/bot.o ../bot.c

${OBJECTDIR}/_ext/5c0/commandExec.o: ../commandExec.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -D__BOTS=1 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/commandExec.o ../commandExec.c

${OBJECTDIR}/_ext/5c0/messageExec.o: ../messageExec.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -D__BOTS=1 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/messageExec.o ../messageExec.c
